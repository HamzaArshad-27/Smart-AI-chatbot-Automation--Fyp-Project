...
If Redis isn't running, start it using your local Redis installation or container/WSL setup.

---

## 4. Celery Does Not Start
...
```powershell
git commit -m "Update Vendora features"
```
...
| -------------- | ------------------------------------------ |
| `accounts`     | Authentication, users, OTP and profiles    |
| `companies`    | Companies and sellers                      |
| `products`     | Products and categories                    |
| `cart`         | Shopping cart                              |
| `orders`       | Orders and order items                     |
| `reports`      | Analytics and reporting                    |
| `ai_assistant` | AI assistant and semantic search           |
| `core`         | Homepage and general website functionality |
...
For developers who already have PostgreSQL, Redis and Python installed:
